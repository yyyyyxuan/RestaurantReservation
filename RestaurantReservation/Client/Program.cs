...
namespace RestaurantReservation.Client
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient("RestaurantReservation.ServerAPI", (sp, client) => { client.BaseAddress = new Uri(builder.HostEnvironment.BaseAddress); client.EnableIntercept(sp); })
